-- ============================================================
-- 05a-fix-failed-views.sql
-- FIX: Recreate views that failed due to incorrect column names
--
-- Run this AFTER 05-gold-finance-views.sql to fix the views
-- that failed with "Invalid column name" errors.
-- ============================================================

-- =========================
--  DROP FAILED VIEWS
-- =========================
DROP VIEW IF EXISTS edp.suppliers;
DROP VIEW IF EXISTS edp.supplier_sites;
DROP VIEW IF EXISTS edp.organizations;
DROP VIEW IF EXISTS edp.gl_journal_lines;
DROP VIEW IF EXISTS edp.purchase_orders;
DROP VIEW IF EXISTS edp.po_lines;
DROP VIEW IF EXISTS edp.po_distributions;
DROP VIEW IF EXISTS edp.projects;
DROP VIEW IF EXISTS edp.project_costs;
DROP VIEW IF EXISTS edp.budget_amounts;
DROP VIEW IF EXISTS edp.ap_invoice_summary;
DROP VIEW IF EXISTS edp.control_budgets;
GO
...
-- ── Organizations (hr tables — uses organizationunitpeo/organizationunittranslationpeo prefix) ──
...
-- ── Control Budgets (xcc_control_budgets — controlbudgetunsecured prefix) ──
...
-- ── AP Invoice Summary (pre-joined — uses corrected supplier column names) ──
